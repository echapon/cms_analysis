...
void StandardHypoTestDemo(RooWorkspace *w,
                          ...
                          int seed=-1)
{
  ...
  if (!bModel ) {
   ...
   cout << "null pval = " << htr->NullPValue() << ", al pval = " << htr->AlternatePValue() << endl;
